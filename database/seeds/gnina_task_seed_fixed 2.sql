-- Fixed GNINA Task Framework Integration Seed
...
INSERT INTO organizations (org_id, name, status, quotas, settings, created_at, updated_at)
VALUES (
    '12345678-1234-1234-1234-123456789012'::uuid,
    'Demo Organization', 
    'active',
    '{"cpu_cores": 100, "memory_gb": 500, "storage_gb": 1000}'::jsonb,
    '{"auto_scaling": true, "notifications": true}'::jsonb,
    NOW(),
    NOW()
) ON CONFLICT (name) DO NOTHING;

-- Get the organization ID for the demo org
...
INSERT INTO task_definitions (
    ...
    gen_random_uuid(),
    (SELECT org_id FROM organizations WHERE name = 'Demo Organization' LIMIT 1),
