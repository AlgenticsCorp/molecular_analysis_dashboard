...
6) Sync Project: update/create issue as needed, ensure item exists in Org Project 1, and set an appropriate **Status** (Backlog/In Progress/In Review/Done) using commands from `.github/PROJECT_MANAGEMENT.md`
...
For GitHub issues, milestones, and project management commands, refer to the comprehensive guide at `.github/PROJECT_MANAGEMENT.md`.
...
For detailed commands, workflows, and advanced operations, see `.github/PROJECT_MANAGEMENT.md`.
